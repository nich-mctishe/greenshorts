...
const schema = Joi.object().keys({
  ...
  billingAddressLine2: Joi.string().allow(null).allow("").error(() => 'billing address should be legeable'),
  billingAddressLine3: Joi.string().allow(null).allow("").error(() => 'billing address should be legeable'),
  billingCity: Joi.string().required().error(() => 'Please enter a billing city'),
  billingCounty: Joi.string().allow(null).allow("").error(() => 'Please amend your billing county'),
  ...
  shippingAddressLine2: Joi.string().allow(null).allow("").error(() => 'shipping address should be legeable'),
  shippingAddressLine3: Joi.string().allow(null).allow("").error(() => 'shipping address should be legeable'),
  shippingCity: Joi.string().required().error(() => 'Please enter a shipping city'),
  shippingCounty: Joi.string().allow(null).allow("").error(() => 'Please amend your shipping county'),
  ...
  instructions: Joi.string().allow(null).allow(""),
  contactTime: Joi.string().allow(null).allow("").error(() => 'Contact time should be a legable'),
